            ...
            <ScrollView style={styles.main}>
                <View style={styles.typeDrink}>
                    ...
                    <View style={styles.drinkRow}>
                        <TouchableOpacity style={styles.imageWrap} onPress={()=>navigation.navigate('ProductDetail')}>
                            <Image source={require('../../assets/img/blended1.png')} style={styles.img}/>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.nameWrap} onPress={()=>navigation.navigate('ProductDetail')}>
