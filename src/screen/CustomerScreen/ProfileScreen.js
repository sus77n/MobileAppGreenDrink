  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <Icon name="crown" style={styles.crownIcon} size={20} color={'white'} />
        ...
        <View style={styles.subHeader}>
          ...
          />
          <Text style={[styles.whiteText, styles.subHeaderText]}>
            {user ? user.stars.toFixed(2) : '0'}
          </Text>
          <Text style={[styles.whiteText, styles.subHeaderText]}>
